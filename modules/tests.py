...
from modules.molecule import MoleculeSpec, build_molecule_problem, xyz_file_to_pyscf_atom_string
...
def compare_optimizers_h2_uccsd(
	*,
	...
	plot_path = _save_convergence_plot(
		...
		save_path=images_dir / f"h2_uccsd_optimizer_comparison_{basis}_{mapper_name}.png",
	)
...
def compare_entanglement_and_reps_h2(
	*,
	...
	plot_path = _save_convergence_plot(
		...
		save_path=images_dir / f"h2_{method}_entanglement_reps_{basis}_{mapper_name}.png",
	)
